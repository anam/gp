...
CodeFile="AdminInv_WastageInsertUpdate.aspx.cs" Inherits="AdminInv_WastageInsertUpdate" Title="Inv_Wastage Insert/Update By Admin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="tableCss">
        <table>
            <tr>
                <td>
                    <asp:Label ID="lblWastageDate" runat="server" Text="WastageDate: ">
                    </asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtWastageDate" runat="server" Text="">
                    </asp:TextBox>
                </td>
            </tr>
            <tr>

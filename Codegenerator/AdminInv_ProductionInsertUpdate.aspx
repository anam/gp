...
CodeFile="AdminInv_ProductionInsertUpdate.aspx.cs" Inherits="AdminInv_ProductionInsertUpdate" Title="Inv_Production Insert/Update By Admin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="tableCss">
        <table>
            <tr>
                <td>
                    <asp:Label ID="lblProductionDate" runat="server" Text="ProductionDate: ">
                    </asp:Label>
                </td>
                <td>

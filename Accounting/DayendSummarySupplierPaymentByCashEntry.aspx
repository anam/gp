<%@ Page Title="" Language="C#" MasterPageFile="~/Login/AdminMaster.master" AutoEventWireup="true" CodeFile="DayendSummarySupplierPaymentByCashEntry.aspx.cs" Inherits="Accounting_DayendSummaryEntry" %>
 ...
 <asp:GridView ID="gvACC_ChartOfAccountLabel4" runat="server" AutoGenerateColumns="false" CssClass="gridCss">
            <Columns>
               ...
               <asp:TemplateField HeaderText="Supplyer Payment">
                    ...
                    <div style='display:none;'>
                    <asp:TextBox ID="txtCheckNo" runat="server" Width="75px" Text="0" style="text-align:right;"></asp:TextBox>
                ...
                <asp:TemplateField HeaderText="Fund Transfer" Visible="false">
                    <ItemTemplate>

...
public partial class Accounting_Summary : System.Web.UI.Page
{
    ...
    private void loadData()
    {
        string Sql = @"Select SUM(Debit-Credit) as Balance,ACC_ChartOfAccountLabel4.ChartOfAccountLabel4Text as Supplier,ACC_ChartOfAccountLabel4.ACC_ChartOfAccountLabel4ID
            ...
            where ACC_JournalMaster.RowStatusID=1 and ACC_JournalDetail.ACC_ChartOfAccountLabel3ID="+Request.QueryString["L3"]+ @"
            --and ACC_ChartOfAccountLabel4.ACC_HeadTypeID=6
            and ACC_JournalMaster.JournalDate >='" + Request.QueryString["FromDate"] + @"'  and ACC_JournalMaster.JournalDate <'" + Request.QueryString["Date"] + @"'
        ...
        foreach (DataRow dr in ds.Tables[0].Rows)
        {
            ...
            dr["Supplier"] = "<a href='GeneralLedgerPrint.aspx?ACC_ChartOfAccountLabel4ID=" + dr["ID"].ToString() + "&ACC_ChartOfAccountLabel3ID=" + Request.QueryString["L3"] + @"&WorkStationID=0&FromDate=2013-01-01%2012:00:00%20AM&ToDate=" + DateTime.Today.ToString("yyyy-MM-dd") + "%2011:59:59%20PM' target='_blank'>" + dr["Supplier"].ToString() + "</a>";
        }

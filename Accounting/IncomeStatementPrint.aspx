<%@ Page Title="" Language="C#" MasterPageFile="~/WithoutLeftMenuPrint.master" AutoEventWireup="true" CodeFile="IncomeStatementPrint.aspx.cs" Inherits="Accounting_Voucher" %>
...
<style type="text/css">
    ...
    .tableBorder tr td{border:1px solid black;font-weight:bold;}
</style>
</asp:Content>
        ...
        <tr>
            <td align="center" style="margin:5px;">
                <p style="padding:10px;font-weight:bold;"><span style="border:1px double black;padding:5px;">
                    <asp:Label ID="lblStatement" runat="server" Text="INCOME STATEMENT"></asp:Label>
                </span></p>
                <br />

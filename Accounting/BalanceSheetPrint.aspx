<%@ Page Title="" Language="C#" MasterPageFile="~/WithoutLeftMenuPrint.master" AutoEventWireup="true" CodeFile="BalanceSheetPrint.aspx.cs" Inherits="Accounting_Voucher" %>
        ...
        <tr>
            <td align="center" style="margin:5px;">
                <p style="padding:10px;font-weight:bold;"><span style="border:1px double black;padding:5px;">
                    <asp:Label ID="lblStatement" runat="server" Text="BALANCE SHEET"></asp:Label>
                </span></p>
                <br />

<%@ Page Title="" Language="C#" MasterPageFile="~/WithoutLeftMenuPrint.master" AutoEventWireup="true" CodeFile="GeneralLedger4TransactionSearchPrint.aspx.cs" Inherits="Accounting_Voucher" %>
...
<div align="center" style="width:900px;font-weight:bold;">
    <table>
        ...
        <tr>
            <td>
                <table runat="server" style="font-weight:bold;margin:10px 0;" id='tableAccountTitle'  border='0' cellspacing='0' cellpadding='0' width="100%">
                    <tr>
                        <td width="100px">Accounts Title:</td>
                        <td>
                            <asp:Label ID="lblAccountTitle" runat="server" Text=""></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>Accounts Code:</td>

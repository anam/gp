...
public partial class Accounting_Voucher : System.Web.UI.Page
{
    ...
    private void loadData()
    {
        try
        {
            ...
            { }
            */
            List<ACC_JournalDetail> journalDetailsCurrentYear = ACC_JournalDetailManager.GP_GetAllACC_JournalDetailForTransactionSearchForSearchByLabel
                (Request.QueryString["JournalMasterName"], Request.QueryString["L1"], Request.QueryString["L2"], Request.QueryString["L3"], Request.QueryString["L4"],Request.QueryString["WorkStationID"],
                   fromDateCurrentYear,
                  toDate
                );
            ...
            foreach (ACC_JournalDetail journalDetail in journalDetailsCurrentYear)
            {
                ...
                <td>
                  <a target=" + "\"_blank\"  href=\"GeneralLedger4TransactionSearchPrint.aspx?ACC_ChartOfAccountLabel4ID=" + Request.QueryString["L4"] + @"&ACC_ChartOfAccountLabel3ID=" + journalDetail.ACC_ChartOfAccountLabel3ID
            + "&WorkStationID="+Request.QueryString["WorkStationID"] +@"&FromDate=" + fromDateCurrentYear + "&JournalMasterName=" + Request.QueryString["JournalMasterName"]

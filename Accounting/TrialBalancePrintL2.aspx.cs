...
public partial class Accounting_Voucher : System.Web.UI.Page
{
    ...
    private void loadData()
    {
        try
        {
            ...
            if (Request.QueryString["TrialBalance"] != null)
            {
...
//                <td>
//                  <a target='_blank'  href='GeneralLedgerPrint.aspx?ACC_ChartOfAccountLabel4ID="+L4.ToString()+@"&ACC_ChartOfAccountLabel2ID=" + journalDetail.ACC_ChartOfAccountLabel3ID
...
//                ";
                ...
                <td>
                    " + journalDetail.ACC_ChartOfAccountLabel3Code + @"</td>
                <td>
                  <a target='_blank'  href='TrialBalancePrint.aspx?L4=" + L4.ToString() + @"&L1=0&L2=" + journalDetail.ACC_ChartOfAccountLabel3ID
            + "&L3=0&WorkStationID=0&FromDate=" + fromDateCurrentYear
            + "&Date=" + toDate + @"'>" + journalDetail.ACC_ChartOfAccountLabel3Text + @"</a> </td>
                ";
            ...
            lblJournalDetials.Text = journalDetailsHTML + "<tr><td></td><td><b>Total:</b></td><td style='text-align:right;'>" + currentYearDebit.ToString("0,0.00") + @"</td><td style='text-align:right;'>" + currentYearCredit.ToString("0,0.00") + @"</td></tr></table>";

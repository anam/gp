...
public class Inv_Wastage
{
    ...
    {
        this.Inv_WastageID = inv_WastageID;
    ...
    private int _inv_WastageID;
    public int Inv_WastageID
    {
        get { return _inv_WastageID; }
        set { _inv_WastageID = value; }
    }

    private DateTime _wastageDate;
    public DateTime WastageDate
    {
        get { return _wastageDate; }
        set { _wastageDate = value; }
    }

<%@ Page Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true"
    CodeFile="AdminInv_PurchaseAdjustmentDisplay.aspx.cs" Inherits="AdminInv_PurchaseAdjustmentDisplay" Title="Display Inv_PurchaseAdjustment By Admin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div>
        ...
        <asp:GridView ID="gvInv_PurchaseAdjustment" runat="server" AutoGenerateColumns="false" CssClass="gridCss">
            <Columns>
                <asp:TemplateField HeaderText="Select">
                    <ItemTemplate>
                        <asp:LinkButton ID="lbSelect" runat="server" CommandArgument='<%#Eval("Inv_PurchaseAdjustmentID") %>' OnClick="lbSelect_Click">
                            Select
                        </asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="PurchseAdjustmentDate">
                    <ItemTemplate>
                        <asp:Label ID="lblPurchseAdjustmentDate" runat="server" Text='<%#Eval("PurchseAdjustmentDate") %>'>
                        </asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="PurchaseIDs">
                    <ItemTemplate>
                        <asp:Label ID="lblPurchaseIDs" runat="server" Text='<%#Eval("PurchaseIDs") %>'>
                        </asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Delete">
                    <ItemTemplate>
                        <asp:LinkButton ID="lbDelete" runat="server" CommandArgument='<%#Eval("Inv_PurchaseAdjustmentID") %>' OnClick="lbDelete_Click">
                            Delete
                        </asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>

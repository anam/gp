<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IssuePrint.aspx.cs" Inherits="Inventory_PurchasePrint" %>
...
<body>
    ...
    <div align="center" style="font-family:Verdana;font-size:15px;">
        <table width="900px">
            <tr>
            ...
            <tr>
                <td align="center" >
                    <span style='font-size:14px;font-weight:bold;text-decoration:unerline;'>Issue Rawmaterials</span>
            ...
            <tr>
                <td>
                    <table style="border:1px solid Black;width:100%;" > 
                        <tr>
                            <td style="width:100px;" class="PurchaseHeaderCss">Issue Date</td>
                    ...
                    <asp:Label ID="lblPurchaseDate" runat="server" Text=""></asp:Label>
                        ...
                        <tr>
                            <td class="PurchaseHeaderCss">Issue ID</td>
                            <td>:</td>
                            <td>
                        ...
                        <tr>
                            <td class="PurchaseHeaderCss" >Issue To</td>
                            <td>:</td>
                            <td>
        ...
        <table width="800px" style="font-size:12px;">
            <tr>
            <td align="left" style="padding:0 20px;border-top:1px dashed black;width:80px;">Issued By</td>
                <td></td>
                <td align="left" style="padding:0 20px;border-top:1px dashed black;width:100px;">Store InCharge</td>
                <td></td>
                <td align="center" style="padding:0 20px;border-top:1px dashed black;width:110px;">Received By</td>
                <td></td>
                <td align="right" style="padding:0 20px;border-top:1px dashed black;width:140px;">Authorised Signature</td>
            </tr>
        </table>
    </div>
    </form>

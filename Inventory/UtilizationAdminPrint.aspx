<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UtilizationAdminPrint.aspx.cs" Inherits="Inventory_PurchasePrint" %>
...
<body>
    ...
    <div align="center" style="font-family:Verdana;font-size:12px;">
        <table width="800px">
            ...
            <tr>
                <td align="center" >
                    <span style='font-size:14px;font-weight:bold;text-decoration:unerline;'>Utilization Voucher</span>
            ...
            <tr>
                <td>
                    ...
                    <asp:Label ID="lblPurchaseDate" runat="server" Text=""></asp:Label>
                               &nbsp; <asp:LinkButton ID="lbtnDelete" runat="server" style="color:Red;text-decoration:underline;" onclick="lbtnDelete_Click">X</asp:LinkButton>
                            </td>
                        </tr>

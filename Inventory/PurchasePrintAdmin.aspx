<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PurchasePrintAdmin.aspx.cs" Inherits="Inventory_PurchasePrint" %>
            ...
            <tr>
                <td>
                    ...
                    <asp:Label ID="lblPurchaseDate" runat="server" Text=""></asp:Label>
                        ...
                        <tr >
                            <td class="PurchaseHeaderCss">Amount</td>
                            <td>:</td>
                            <td>
                        ...
                        <tr >
                            <td class="PurchaseHeaderCss"></td>
                            <td>:</td>
                            <td>
                                <asp:Button ID="btnAdjustPriceAll" runat="server" Text="Adjust price" 
                                    onclick="btnAdjustPriceAll_Click" />
                            </td>
                        </tr>
                    </table>
                </td>

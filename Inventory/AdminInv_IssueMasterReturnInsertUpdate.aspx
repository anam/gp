...
CodeFile="AdminInv_IssueMasterReturnInsertUpdate.aspx.cs" Inherits="AdminInv_IssueMasterReturnInsertUpdate" Title="Inv_IssueMasterReturn Insert/Update By Admin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="tableCss">
        <table>
            <tr>
                <td>
                    <asp:Label ID="lblIssueReturnName" runat="server" Text="IssueReturnName: ">
                    </asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtIssueReturnName" runat="server" Text="">
                    </asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:Label ID="lblIssueReturnDate" runat="server" Text="IssueReturnDate: ">
                    </asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtIssueReturnDate" runat="server" Text="">
                    </asp:TextBox>
                </td>
            </tr>
            <tr>

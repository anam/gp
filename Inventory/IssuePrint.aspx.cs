...
public partial class Inventory_PurchasePrint : System.Web.UI.Page
{
    ...
    private void loadData()
    {
        ...
        lblPurchaseID.Text = issueMaster.Inv_IssueMasterID.ToString();
        ...
        if (issueMaster.IsIssue)
        {
            ...
            string htmlTable = @" <table id='itemList_tbl' style='border:1px solid black;width:100%;' cellpadding='0' cellspacing='0'>
                        <tr id='tableHeader'>
                            ...
                            <td>Quantity</td>
                            <td>Unit</td>
                            <td  style='display:none;'>Unit price</td>
                            <td  style='display:none;'>Amount</td>
                            <td>Quality</td>
                            <td>Issue For</td>
                            <td  style='display:none;'>Qppx. Qty</td>
                        </tr>";
            int lastProductID = 0;
            ...
            foreach (Inv_IssueDetail AddedIssedItem in inv_IssueDetailsArranged)
            {
                if (lastProductID != 0 && lastProductID != AddedIssedItem.ProductID)
                {
                    htmlTable += @"<tr class='subtotalRow'>
                            ...
                            <td  style='display:none;'>" + subTotalAmount.ToString("0,0.00") + @"</td>
                            <td>&nbsp;</td>
                            <td>&nbsp;</td>
                            <td style='display:none;'>" + subTotalAppxQty.ToString("0,0.00") + @"</td>
                        </tr>";
                ...
                htmlTable += @"<tr class='itemCss'>
                            ...
                            <td style='text-align:right;display:none;'>" + AddedIssedItem.PricePerUnit.ToString("0,0.00") + @"</td>
                            <td style='text-align:right;display:none;'>" + AddedIssedItem.TotalPrice.ToString("0,0.00") + @"</td>
                            <td>" + AddedIssedItem.QualityUnitValue + @" - " + AddedIssedItem.QualityUnitName + @"</td>                          
                            <td>" + AddedIssedItem.ProductName + @"</td>
                            <td style='text-align:right;display:none;'>" + AddedIssedItem.ApproximateQuantity.ToString("0,0.00") + @"</td>
                        </tr>";
            ...
            htmlTable += @"<tr  id='lastRow'>
                            ...
                            <td>&nbsp;</td>
                            <td  style='display:none;'>&nbsp;</td>
                            <td  style='display:none;'>" + totalAmount.ToString("0,0.00") + @"</td>
                            <td>&nbsp;</td>
                            <td>&nbsp;</td>
                            <td style='display:none;'>" + totalAppxQty.ToString("0,0.00") + @"</td>
                        </tr></table>";

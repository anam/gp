<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IssueReportItemWisePrint.aspx.cs" Inherits="Inventory_PurchasePrint" %>
...
<head runat="server">
    ...
    <style type="text/css">
        ...
        #itemList_tbl td{padding:2px 10px;font-size:15px;}
...
<body>
    ...
    <div align="center" style="font-family:Verdana;font-size:12px;">
        <table width="800px">
            ...
            <tr>
                <td align="center" >
                    <span style='font-size:14px;font-weight:bold;text-decoration:unerline;'>Issue Report</span>

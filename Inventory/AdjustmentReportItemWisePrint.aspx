<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdjustmentReportItemWisePrint.aspx.cs" Inherits="Inventory_PurchasePrint" %>
...
<body>
    ...
    <div align="center" style="font-family:Verdana;font-size:12px;">
        <table width="800px">
            ...
            <tr>
                <td align="center" >
                    <span style='font-size:14px;font-weight:bold;text-decoration:unerline;'>Adjustment Report</span>

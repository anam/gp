...
CodeFile="AdminInv_PurchaseAdjustmentInsertUpdate.aspx.cs" Inherits="AdminInv_PurchaseAdjustmentInsertUpdate" Title="Inv_PurchaseAdjustment Insert/Update By Admin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="tableCss">
        <table>
            <tr>
                <td>
                    <asp:Label ID="lblPurchseAdjustmentDate" runat="server" Text="PurchseAdjustmentDate: ">
                    </asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtPurchseAdjustmentDate" runat="server" Text="">
                    </asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:Label ID="lblPurchaseIDs" runat="server" Text="PurchaseIDs: ">
                    </asp:Label>
                </td>
                <td>

...
CodeFile="AdminInv_PurchaseReturenInsertUpdate.aspx.cs" Inherits="AdminInv_PurchaseReturenInsertUpdate" Title="Inv_PurchaseReturen Insert/Update By Admin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="tableCss">
        <table>
            <tr>
                <td>
                    <asp:Label ID="lblPurchseReturenDate" runat="server" Text="PurchseReturenDate: ">
                    </asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtPurchseReturenDate" runat="server" Text="">
                    </asp:TextBox>
                </td>
            </tr>
            <tr>

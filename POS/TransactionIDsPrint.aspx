<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TransactionIDsPrint.aspx.cs"
...
<body>
    ...
    <div align="center" style="font-family: Verdana; font-size: 12px;">
        ...
        <table width="800px">
            <tr>
                <td>
                    <asp:GridView ID="gvTransactionIDs" runat="server" AutoGenerateColumns="false" CssClass="gridCss">
                        <Columns>
                            <asp:TemplateField HeaderText="Date">
                                <ItemTemplate>
                                    <asp:Label ID="lblBankName" runat="server" Text='<%#Eval("TransactionDate","{0:dd/MM/yyyy}") %>'>
                                        </asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Transaction">
                                <ItemTemplate>
                                    <asp:Label ID="lblDetails" runat="server" Text='<%#Eval("TransactionTypeName") %>'>
                        </asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Transaction In">
                                <ItemTemplate>
                                    <asp:Label ID="lblCharOfAccountLabel4ID" runat="server" Text='<%#Eval("ByWorkStatonName") %>'>
                        </asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Transaction To/For/From">
                                <ItemTemplate>
                                    <asp:Label ID="lblFromOrTo" runat="server" Text='<%#Eval("FromOrTo") %>'>
                        </asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="ID">
                                <ItemTemplate>
                                    <a target="_blank" href='TransactionPrint.aspx?Pos_TransactionMasterID=<%#Eval("Pos_TransactionMasterID") %>'>
                                    <%#Eval("TransactionID")%>
                        </a>
                                </ItemTemplate>
                            </asp:TemplateField>

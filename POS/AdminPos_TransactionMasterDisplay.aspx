<%@ Page Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true"
    CodeFile="AdminPos_TransactionMasterDisplay.aspx.cs" Inherits="AdminPos_TransactionMasterDisplay" Title="Display Pos_TransactionMaster By Admin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div>
        ...
        <asp:GridView ID="gvPos_TransactionMaster" runat="server" AutoGenerateColumns="false" CssClass="gridCss">
            <Columns>
                <asp:TemplateField HeaderText="Select">
                    <ItemTemplate>
                        <asp:LinkButton ID="lbSelect" runat="server" CommandArgument='<%#Eval("Pos_TransactionMasterID") %>' OnClick="lbSelect_Click">
                            Select
                        </asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Pos_TransactionTypeID">
                    <ItemTemplate>
                        <asp:Label ID="lblPos_TransactionTypeID" runat="server" Text='<%#Eval("Pos_TransactionTypeID") %>'>
                        </asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="ToOrFromID">
                    <ItemTemplate>
                        <asp:Label ID="lblToOrFromID" runat="server" Text='<%#Eval("ToOrFromID") %>'>
                        </asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Record">
                    <ItemTemplate>
                        <asp:Label ID="lblRecord" runat="server" Text='<%#Eval("Record") %>'>
                        </asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Delete">
                    <ItemTemplate>
                        <asp:LinkButton ID="lbDelete" runat="server" CommandArgument='<%#Eval("Pos_TransactionMasterID") %>' OnClick="lbDelete_Click">
                            Delete
                        </asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>

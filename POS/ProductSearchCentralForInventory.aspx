<%@ Page Language="C#" MasterPageFile="~/login/AdminMaster.master" AutoEventWireup="true"
    CodeFile="ProductSearchCentralForInventory.aspx.cs" Inherits="AdminPos_ProductDisplay" Title="Display Pos_Product By Admin" %>
        ...
        <ContentTemplate>
            ...
            <table>
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtBarCode" runat="server" Width="330px" Height="60px" AutoPostBack="true"
                            TextMode="MultiLine" OnTextChanged="txtBarCode_TextChanged"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlColorSearch" runat="server" Visible="false">
                        </asp:DropDownList>
                    ...
                    <td colspan="2">
                        <table>
                            <tr>
                                ...
                                <td>
                                    <asp:HyperLink ID="hlnkBarCodePrint" Target="_blank" Visible="false" runat="server">Print barcode</asp:HyperLink>
                                </td>
                            </tr>
                        </table>
                    </td>
            ...
            <asp:Label ID="lblProductPreview" runat="server" Text=""></asp:Label>
        </ContentTemplate>
    </asp:UpdatePanel>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StockReportInWorkStationByDateItemWise10DigitPrint.aspx.cs" Inherits="Inventory_PurchasePrint" %>
...
<head runat="server">
    ...
    <style type="text/css">
        ...
        .subtotalRow_price{font-weight:bold;text-align:right;border-top:1px solid black;border-bottom:1px solid black;}
    </style>
</head>
<body>
    ...
    <div align="center" style="font-family:Verdana;font-size:12px;">
        <table width="800px">
            ...
            <tr>
                <td align="center" >
                    <span style='font-size:14px;font-weight:bold;text-decoration:unerline;'>WorkStation Stock Report(Product Wise)</span>
                    <br />
                    <b >Date: </b> 

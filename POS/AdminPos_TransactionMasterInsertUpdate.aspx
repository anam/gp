...
CodeFile="AdminPos_TransactionMasterInsertUpdate.aspx.cs" Inherits="AdminPos_TransactionMasterInsertUpdate" Title="Pos_TransactionMaster Insert/Update By Admin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="tableCss">
        <table>
            <tr>
                <td>
                    <asp:Label ID="lblTransactionDate" runat="server" Text="TransactionDate: ">
                    </asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtTransactionDate" runat="server" Text="">
                    </asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:Label ID="lblPos_TransactionTypeID" runat="server" Text="Pos_TransactionTypeID: ">
                    </asp:Label>
                </td>
                <td>
                    <asp:DropDownList ID="ddlPos_TransactionType" runat="server">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:Label ID="lblTransactionID" runat="server" Text="TransactionID: ">
                    </asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <asp:Label ID="lblToOrFromID" runat="server" Text="ToOrFromID: ">
                    </asp:Label>
                </td>
                <td>
                    <asp:DropDownList ID="ddlToOrFrom" runat="server">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:Label ID="lblRecord" runat="server" Text="Record: ">
                    </asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtRecord" runat="server" Text="">
                    </asp:TextBox>
                </td>
            </tr>
            <tr>

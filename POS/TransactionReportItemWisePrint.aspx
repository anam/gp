<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TransactionReportItemWisePrint.aspx.cs" Inherits="Inventory_PurchasePrint" %>
...
<body>
    ...
    <div align="center" style="font-family:Verdana;font-size:12px;">
        ...
        <asp:HiddenField ID="hfGrandQty" runat="server" Value="0"/>
        <asp:HiddenField ID="hfGrandAmount" runat="server"  Value="0"/>  
        <br />
        <br />
        <br />
        <br />

<%@ Page Language="C#" MasterPageFile="~/login/AdminMaster.master" AutoEventWireup="true"
    CodeFile="AdminPos_TransactionDisplay.aspx.cs" Inherits="AdminPos_TransactionDisplay" Title="Display Pos_Transaction By Admin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div>
        ...
        <asp:GridView ID="gvPos_Transaction" runat="server" AutoGenerateColumns="false" CssClass="gridCss">
            <Columns>
                <asp:TemplateField HeaderText="Select">
                    <ItemTemplate>
                        <asp:LinkButton ID="lbSelect" runat="server" CommandArgument='<%#Eval("Pos_TransactionID") %>' OnClick="lbSelect_Click">
                            Select
                        </asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Pos_ProductID">
                    <ItemTemplate>
                        <asp:Label ID="lblPos_ProductID" runat="server" Text='<%#Eval("Pos_ProductID") %>'>
                        </asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Pos_ProductTrasactionTypeID">
                    <ItemTemplate>
                        <asp:Label ID="lblPos_ProductTrasactionTypeID" runat="server" Text='<%#Eval("Pos_ProductTrasactionTypeID") %>'>
                        </asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Pos_ProductTransactionMasterID">
                    <ItemTemplate>
                        <asp:Label ID="lblPos_ProductTransactionMasterID" runat="server" Text='<%#Eval("Pos_ProductTransactionMasterID") %>'>
                        </asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="WorkStationID">
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="Delete">
                    <ItemTemplate>
                        <asp:LinkButton ID="lbDelete" runat="server" CommandArgument='<%#Eval("Pos_TransactionID") %>' OnClick="lbDelete_Click">
                            Delete
                        </asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>

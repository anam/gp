<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TransactionPrint_inventory.aspx.cs" Inherits="Inventory_PurchasePrint" %>
            ...
            <tr>
                <td align="center" >
                    <span style='font-size:14px;font-weight:bold;text-decoration:unerline;'>
                        <asp:Label ID="lblVoucherType" runat="server" Text=""></asp:Label> Voucher</span>
            ...
            <tr>
                <td>
                    <table style="border:1px solid Black;width:100%;" > 
                        <tr>
                            <td style="width:112px;" class="PurchaseHeaderCss">Date</td>
                    ...
                    <asp:Label ID="lblPurchaseDate" runat="server" Text=""></asp:Label>
                        ...
                        <tr>
                            <td class="PurchaseHeaderCss">ID</td>
                            <td>:</td>
                            <td>
                                <asp:Label ID="lblTransactionID" runat="server" Text=""></asp:Label>
                            </td>
                        </tr>
                        <tr id="trRefference" runat="server">
                        ...
                        <tr id="trToOrFrom" runat="server">
                            <td class="PurchaseHeaderCss">To/From</td>
                            <td>:</td>
                            <td>
